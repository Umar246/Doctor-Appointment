...
import banner from '../../../assets/images/banner-image-2.jpg'
      ...
      <div className="heroSection">
        <div className="row">
          <div className="col-12">
            <div className="bg-1">
              <img src={banner} className='bg bg-1' />
            </div>
            <div className="bg-2">
            ...
            <div className="col">
              <div className="card button1 mt-sm-5">
                ...
                <div className="d-flex">
                  ...
                  <div className="buttn">
                    <button type="button " className="btn btn-primary " style={{backgroundColor:'#A6A7FA'}}>EXPLORE</button>
                  </div>
                </div>
